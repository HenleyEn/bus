#ifndef BSP_SPI_FLASH_W25Q64_DRIVER_H
#define BSP_SPI_FLASH_W25Q64_DRIVER_H
...
#define W25Qx_CS_HIGH()    HAL_GPIO_WritePin(CS_GPIO_Port, CS_Pin, GPIO_PIN_RESET)
#define W25Qx_CS_LOW()   HAL_GPIO_WritePin(CS_GPIO_Port, CS_Pin, GPIO_PIN_SET)
...
#endif /* endif BSP_SPI_FLASH_W25Q64_DRIVER_H */
